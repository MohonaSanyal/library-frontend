<template>
  ...
  export default {
    ...
    methods: {
      async getVenue() {
        try {
          const response = await axios.get('https://ticketshow-api.onrender.com/venue/${this.$route.params.sectionid}');
      ...
      submitData(e) {
        axios({
          method: 'patch',
          url: 'https://ticketshow-api.onrender.com/venue/${this.$route.params.sectionid}/edit',
          data: this.venue,
          headers: {
