...
<template>
	...
	<div class="jumbotron text-center cyan">
		<h2>Create Book</h2>
        <router-link to="/admindashboard">See all already created sections and books here</router-link>
	</div>
...
export default {
  ...
  methods: {
    submitData(e) {
      ...
      axios({
        method: "post",
        url: `https://ticketshow-api.onrender.com/${this.$route.params.sectionid}/createShow`,
        data: this.show,
        headers: {
